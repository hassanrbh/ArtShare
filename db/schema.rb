...
ActiveRecord::Schema[7.0].define(version: 20_220_325_183_814) do
  ...
  create_table 'tags', force: :cascade do |t|
    ...
    t.datetime 'created_at', null: false
    t.datetime 'updated_at', null: false
    t.index %w[tageable_type tageable_id], name: 'index_tags_on_tageable'
    t.index %w[tageable_type tageable_id], name: 'index_tags_on_tageable_type_and_tageable_id'
  end
